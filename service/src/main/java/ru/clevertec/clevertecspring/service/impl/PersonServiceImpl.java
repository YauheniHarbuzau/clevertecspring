...
import ru.clevertec.clevertecspring.mapper.PersonMapper;
...
public class PersonServiceImpl implements PersonService {
     ...
     */
    @Override
    public List<PersonResponse> getHouseResidentsAllTime(UUID houseUuid) {
        return personRepository.findHouseResidentsAllTime(houseUuid).stream()
                .map(personMapper::toResponse)
                .toList();
    }
