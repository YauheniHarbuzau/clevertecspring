...
public class HouseController {
    ...
    @GetMapping("resident/{personuuid}/alltime")
    @Operation(summary = "Get Houses", description = "Get Houses For All Time By Person (Resident) UUID")
    public ResponseEntity<List<HouseResponse>> getResidentHousesAllTime(@PathVariable("personuuid") UUID personUuid) {
        return ResponseEntity.ok(houseService.getResidentHousesAllTime(personUuid));
    }
