...
import static ru.clevertec.clevertecspring.constant.Constant.HOUSE_FIND_RESIDENT_HOUSES_ALL_TIME;
...
public interface HouseRepository extends JpaRepository<House, UUID> {
    ...
    @Query(value = HOUSE_FIND_RESIDENT_HOUSES_ALL_TIME, nativeQuery = true)
    List<House> findResidentHousesAllTime(UUID personUuid);
